...
const DOC_TASKS: Record<string, string> = {
  ...
  case_study: "Build a CASE STUDY. If REAL PROVEN RESULTS are provided above, write a truthful case study built ONLY on those real, anonymised figures: the situation, what was done, the real measured results, and how it relates to this client. You must NEVER invent a company name, a metric, a percentage, a dollar figure, or a timeframe, and never present a fictional company as real. If NO real proven results are provided, do NOT invent a past client or a fictional company under any circumstances; instead write a 'How I would approach a business like yours' piece that walks through the real methodology applied to THIS prospect's specific situation and real findings, clearly framed as the approach, not a past outcome. 350 to 500 words. Never use an em-dash.",
};
