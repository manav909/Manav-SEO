...
export async function handleBrandStudio(action: string, body: any): Promise<any | null> {
  switch (action) {
    ...
    /* Phase 10c — S.E.A.S.O.N. data-write actions */
    case "bs_season_action_save_data_room_note": {
      const { bsSeasonActionSaveDataRoomNote } = await import("./season-write-actions.js");
      return bsSeasonActionSaveDataRoomNote(body);
    }
    case "bs_season_action_update_strategy_status": {
      const { bsSeasonActionUpdateStrategyStatus } = await import("./season-write-actions.js");
      return bsSeasonActionUpdateStrategyStatus(body);
    }
    case "bs_season_action_add_kanban_note": {
      const { bsSeasonActionAddKanbanNote } = await import("./season-write-actions.js");
    ...
    /* Phase 13a — async launch (returns run_id immediately, runs in background) */
    case "bs_season_pipeline_launch": {
    ...
    case "bs_season_pipeline_create": {
      ...
      return bsSeasonPipelineCreate(body);
    }
    case "bs_season_pipeline_execute_next": {
      const { bsSeasonPipelineExecuteNext } = await import("./season-pipeline-routes.js");
      return bsSeasonPipelineExecuteNext(body);
    }
    ...
    case "bs_seo_war_room_briefing": {
      const { bsSeoWarRoomBriefing } = await import("./seo-campaign-routes.js");
    ...
    case "bs_seo_manavs_pick": {
      const { bsSeoManavsPick } = await import("./seo-campaign-routes.js");
      return bsSeoManavsPick(body);
    }

    case "bs_seo_manavs_pick_action": {
      const { bsSeoManavsPickAction } = await import("./seo-campaign-routes.js");
      return bsSeoManavsPickAction(body);
    }

    case "bs_seo_manavs_pick_pull": {
      const { bsSeoManavsPickPull } = await import("./seo-campaign-routes.js");
      return bsSeoManavsPickPull(body);
    }

    case "bs_seo_client_questions": {
      const { bsSeoClientQuestions } = await import("./seo-campaign-routes.js");
      return bsSeoClientQuestions(body);
    }

    case "bs_seo_client_recap": {
      const { bsSeoClientRecap } = await import("./seo-campaign-routes.js");
      return bsSeoClientRecap(body);
    }

    case "bs_seo_pick_engine_get": {
      const { bsSeoPickEngineGet } = await import("./seo-campaign-routes.js");
      return bsSeoPickEngineGet(body);
    }

    case "bs_seo_pick_engine_archive": {
      const { bsSeoPickEngineArchive } = await import("./seo-campaign-routes.js");
      return bsSeoPickEngineArchive(body);
    }

    case "bs_seo_pick_engine_regenerate": {
      const { bsSeoPickEngineRegenerate } = await import("./seo-campaign-routes.js");
      return bsSeoPickEngineRegenerate(body);
    }

    case "bs_seo_corpus_enrich_batch": {
      const { bsSeoCorpusEnrichBatch } = await import("./seo-campaign-routes.js");
      return bsSeoCorpusEnrichBatch(body);
    }

    case "bs_seo_project_snapshot_refresh": {
      const { bsSeoProjectSnapshotRefresh } = await import("./seo-campaign-routes.js");
    ...
    /* Phase 21 Block 2.7 — Client Lens cinematic page aggregator */
    case "bs_client_lens_load": {
      const { bsClientLensLoad } = await import("./seo-campaign-routes.js");
      return bsClientLensLoad(body);
    }
    ...
    /* Phase 19 — monitoring pillar */
    case "bs_seo_monitoring_run": {
      const { bsSeoMonitoringRun } = await import("./seo-campaign-routes.js");
      return bsSeoMonitoringRun(body);
    }
    case "bs_seo_monitoring_data": {
      const { bsSeoMonitoringData } = await import("./seo-campaign-routes.js");
      return bsSeoMonitoringData(body);
    }
