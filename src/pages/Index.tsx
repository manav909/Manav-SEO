    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 pt-12 pb-16 text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-up" style={{ animationDelay: '0.15s' }}>
          Drop your URL, pick your goal, I architect the end-to-end digital growth for brands that can't afford to fail.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-muted-foreground animate-fade-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center gap-2"><Globe className="h-4 w-4 text-primary" /> Global Rank No. 1</div>
          <div className="flex items-center gap-2"><Brain className="h-4 w-4 text-primary" /> Dominate AI LLMs</div>
          <div className="flex items-center gap-2"><Sparkles className="h-4 w-4 text-primary" /> Strategy That Works</div>
        </div>
      </section>
      ...
      <footer className="relative z-10 mt-24 py-8 text-center text-xs text-muted-foreground border-t border-border">
        © 2026 Manav SEO — Digital Marketing Operating System (DMOS)
      </footer>
    </main>
  );
};
