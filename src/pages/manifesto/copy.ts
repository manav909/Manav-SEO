...
export const COPY: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    hero_sub:                   'Designed, built, and run by Manav. Thinks in seasons. Verified in minutes.',
    scroll_hint:                'Begin',
    nav_label:                  'The Codex',
    chapter:                    'Chapter',
  ...
  hi: {
    ...
    hero_sub:                   'मनव द्वारा डिज़ाइन, निर्मित और संचालित। ऋतुओं में सोचता है। मिनटों में सत्यापित।',
  ...
  es: {
    ...
    hero_sub:                   'Diseñada, construida y operada por Manav. Piensa en estaciones. Verificada en minutos.',
  ...
  fr: {
    ...
    hero_sub:                   'Conçue, construite et exploitée par Manav. Pense en saisons. Vérifiée en minutes.',
  ...
  de: {
    ...
    hero_sub:                   'Entworfen, gebaut und betrieben von Manav. Denkt in Jahreszeiten. Verifiziert in Minuten.',
