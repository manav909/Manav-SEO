...
export const COPY: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    hero_epigraph:              'Every system. Every line. One architect.',
    hero_founder_name:          'Manav',
    hero_roles:                 'Architect · Operator · Founder',
    hero_transition:            'presents',
  ...
  hi: {
    ...
    hero_epigraph:              'हर प्रणाली। हर पंक्ति। एक वास्तुकार।',
    hero_founder_name:          'मनव',
    hero_roles:                 'वास्तुकार · संचालक · संस्थापक',
    hero_transition:            'प्रस्तुत करते हैं',
  ...
  es: {
    ...
    hero_epigraph:              'Cada sistema. Cada línea. Un solo arquitecto.',
    hero_founder_name:          'Manav',
    hero_roles:                 'Arquitecto · Operador · Fundador',
    hero_transition:            'presenta',
  ...
  fr: {
    ...
    hero_epigraph:              'Chaque système. Chaque ligne. Un seul architecte.',
    hero_founder_name:          'Manav',
    hero_roles:                 'Architecte · Opérateur · Fondateur',
    hero_transition:            'présente',
  ...
  de: {
    ...
    hero_epigraph:              'Jedes System. Jede Zeile. Ein Architekt.',
    hero_founder_name:          'Manav',
    hero_roles:                 'Architekt · Betreiber · Gründer',
    hero_transition:            'präsentiert',
