...
export const COPY: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    hero_close:                 'Architect of the system above. He answers when called.',
  ...
  hi: {
    ...
    hero_close:                 'ऊपर के सिस्टम के वास्तुकार। बुलाए जाने पर वह जवाब देता है।',
  ...
  es: {
    ...
    hero_close:                 'Arquitecto del sistema arriba. Responde cuando lo llaman.',
  ...
  fr: {
    ...
    hero_close:                 "Architecte du système ci-dessus. Il répond quand on l'appelle.",
  ...
  de: {
    ...
    hero_close:                 'Architekt des Systems oben. Er antwortet, wenn er gerufen wird.',
