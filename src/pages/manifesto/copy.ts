...
export const COPY: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    hero_sub:                   'Founded by Manav. Built to think in seasons, verified in minutes.',
    scroll_hint:                'Begin',
    nav_label:                  'The Codex',
    chapter:                    'Chapter',
  ...
  hi: {
    ...
    hero_sub:                   'मनव द्वारा स्थापित। ऋतुओं में सोचने के लिए बनी, मिनटों में सत्यापित।',
  ...
  es: {
    ...
    hero_sub:                   'Fundada por Manav. Diseñada para pensar en estaciones, verificada en minutos.',
  ...
  fr: {
    ...
    hero_sub:                   'Fondée par Manav. Conçue pour penser en saisons, vérifiée en minutes.',
  ...
  de: {
    ...
    hero_sub:                   'Gegründet von Manav. Gebaut, um in Jahreszeiten zu denken, in Minuten verifiziert.',
