  ...
  return(
    <div className="empire-page" style={{minHeight:"100vh",background:"hsl(var(--background))",
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center" as const,
        ...
        <div style={{fontSize:15,color:"hsl(var(--muted-foreground))",lineHeight:1.7,marginBottom:36}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:28}}>
          {ROLES.map(({r,l,c,i,desc})=>(
            <div key={r} onClick={()=>{start(r);navigate("/build");}}
              ...
              <div style={{fontSize:12,color:"hsl(var(--muted-foreground))",lineHeight:1.5}}>{desc}</div>
